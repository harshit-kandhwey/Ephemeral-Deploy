...
if __name__ == "__main__":
    ...
    # Binding all interfaces is intentional: this local dev runner must be
    # reachable from the host / other docker-compose services, and it is never
    # the production entrypoint (gunicorn is; see Dockerfile).
